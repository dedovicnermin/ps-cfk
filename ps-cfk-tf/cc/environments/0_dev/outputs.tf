...
output "env_manager_creds" {
  sensitive = true
  value = "${module.dev_pscfk_service_accounts.env_manager_apikey}:${module.dev_pscfk_service_accounts.env_manager_apisecret}"
}


output "sr_em_creds" {
  sensitive = true
  value = "${module.dev_pscfk_service_accounts.sr_em_key}:${module.dev_pscfk_service_accounts.sr_em_secret}"
}
